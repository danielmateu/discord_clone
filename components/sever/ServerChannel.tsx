...
export const ServerChannel = ({
    ...
    return (
        ...
        >
            <Icon className="flex-shrink-0 w-4 h-54 text-zinc-500 dark:text-zinc-400" />
            ...
            {/* Si el nombre del canal es general, mostramos el icono Lock */}
            {channel.name === 'general' && (
                <Lock className="ml-auto w-4 h-4 text-zinc-500 hover:text-zinc-600 dark:text-zinc-400 dark:hover:text-zinc-300 transition" />
            )}
        </button>
    )
}
